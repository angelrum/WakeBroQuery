...
public class TicketEditPageControllerInit {
    ...
    private void initEdit() {
        ...
        controller.startDateColumn.setCellFactory(param -> new DatePickerCell(tickets, DatePickerCell.DateEnum.START, bufferUpd));
        controller.endDateColumn.setCellFactory(param -> new DatePickerCell(tickets, DatePickerCell.DateEnum.END, bufferUpd));
        controller.startTimeColumn.setCellFactory(param -> new TimeCell(tickets, bufferUpd, "startTime"));
        controller.endTimeColumn.setCellFactory(param -> new TimeCell(tickets, bufferUpd, "endTime"));
